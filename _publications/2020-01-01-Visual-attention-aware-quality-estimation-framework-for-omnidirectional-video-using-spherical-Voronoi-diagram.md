...
---
Use [Google Scholar](https://scholar.google.com/scholar?q=Visual+attention+aware+quality+estimation+framework+for+omnidirectional+video+using+spherical+Voronoi+diagram){:target="_blank"} for full citation